...
public class C01_IOException {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Yani try catch ile kontrol altına aldıgımız exception'lar da
        kod calismaya deam ediyordu
        Ancak throws Exception yazdigimizda Java bir exception ile karsilasirsa
        hicbir sey yapmamisiz gibi hata mesaji yayınlayıp, calismayi durdurur
         */
    }
}
