...
public class C03_Exceptions {
    public static void main(String[] args) {
        ...
        yakalanan exception'i atadagimiz variable'in ismi olur (e)

        Eger yakalanan exception ile ilgili bilgileri
        kullaniciya vermek isterseniz
        bu objeyi kullanabilirsiniz
        eger exception ile ilgili bilgi verme ihtiyaci yoksa
        ...
        try {
            ...
            System.out.println("Girdiginiz sira listemizde bulunmjuyor" +
